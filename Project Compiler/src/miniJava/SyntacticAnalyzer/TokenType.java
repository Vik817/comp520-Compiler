...
public enum TokenType {
    NUM, OPERATOR, VISIBILITY, STATIC, ERROR, BOOLEAN, INT, ID, CLASS, THIS, DOT, SEMICOLON, RETURN, IF, ELSE,
    WHILE, TRUEFALSE, COMMA, LPAREN, RPAREN, LBRACK, RBRACK, LCURL, VOID, RCURL, NEW, ONEEQUAL, EXCLAMATION, NEGATIVE, NULL, EOT
}
